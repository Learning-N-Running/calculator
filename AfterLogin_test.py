...
#그룹 추가, 찾기 프레임
afterLogin = Frame(room)
afterLogin.pack(fill="x",padx = 5,pady=10)

btn_add_group=Button(afterLogin,padx=5,pady=5,width=12,text="그룹 추가",command=AddGroup)
btn_add_group.pack(side="left")

btn_search_group=Button(afterLogin,padx=5,pady=5,width=12,text="그룹 찾기",command=SearchGroup)
btn_search_group.pack(side="right")

#그룹들 프레임
frame_group = LabelFrame(room,text="내 그룹",relief="solid",bd=1)
